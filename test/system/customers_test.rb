...
class CustomersTest < ApplicationSystemTestCase
  ...
  test "creating a Customer" do
    ...
    fill_in "Contactno", with: @customer.contactno
    fill_in "Customer name", with: @customer.customer_name
    fill_in "Date", with: @customer.date
    fill_in "Sales person code", with: @customer.sales_person_code
    fill_in "Sales person name", with: @customer.sales_person_name
