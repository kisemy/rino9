class PaymentsController < ApplicationController
  ...
  private
    ...
    def payment_params
      params.require(:payment).permit(:payment_date, :paying_account_code, :paying_acc_description, :prepared_by, :mode_of_payment, :payment_description, :status, :documentno, :release_date, :posted, :amount, :payee_code, :payee_name, :account_type, :category_type, paymentlines_attributes: [:charge_type, :item_no, :description, :quantity, :unit_of_measure, :unit_price, :amount, :_destroy])
    end
